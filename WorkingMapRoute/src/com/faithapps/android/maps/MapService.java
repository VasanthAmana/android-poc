...
public static NavigationDataSet calculateRoute(String startCoords, String targetCoords, int mode) {
    ...
    Log.d("MY_APP", "urlPedestrianMode: "+urlPedestrianMode);
    ...
    Log.d("MY_APP", "urlCarMode: "+urlCarMode);
...
public static NavigationDataSet getNavigationDataSet(String url) {
    ...
    try
        ...
        Log.d("MY_APP","navigationDataSet: "+navigationDataSet.toString());

    } catch (Exception e) {
        // Log.e("MY_APP", "error with kml xml", e);
